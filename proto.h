...
int     assembleFile(char fileName[], char tempName[], std::string outputName, std::string workName);
...
int	movem(int var1, char *var2, char *var3, int *var4);

int	reg(int var1, char *var2, char *var3, int *var4);

int	opt(int var1, char *var2, char *var3, int *var4);
